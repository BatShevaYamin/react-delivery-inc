...
const Home = () => {
  ...
  return (
    <div className="icon-menu" style={{ backgroundColor: '#3f51b5', color: 'white', padding: '10px' }}>
      ...
      {showMenu && (
        <div style={{ position: 'absolute', backgroundColor: '#3f51b5', boxShadow: '0px 8px 16px 0px rgba(0,0,0,0.2)', zIndex: 1 }}>
